...
- Ramos alternados de rosas y girasoles, con marcos y oclusión real delante y detrás del orbe.
...
`public/images/bouquet.webp` y `public/images/roses.webp`: imágenes creadas con la herramienta integrada de generación de imágenes de OpenAI y optimizadas a WebP. No requieren enlaces externos.
